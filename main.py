...
class Game:
    def __init__(self):
        ...
        pygame.display.set_icon(pygame.image.load('C:/Users/ntr07/Desktop/обои/i.jpg'))
    ...
    def gaming(self):
        while self.run:
            label_play_rect = self.label_play.get_rect(topleft=(500, 250))
            ...
            label_arsenal_rect = self.label_arsenal.get_rect(topleft=(500, 400))
